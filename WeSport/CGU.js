...
En vigueur au 07/09/2021
Les présentes conditions générales d'utilisation (dites « CGU ») ont pour objet l'encadrement juridique des modalités de mise à disposition du site et des services par IMSEP et de définir les conditions d’accès et d’utilisation des services par « l'Utilisateur ».
...
L'édition de l'application Talk&Poke est assurée par la Société EQUI au capital de 0 euros, immatriculée au RCS de PARIS sous le numéro 901 795 336, dont le siège social est situé au 21 RUE DU VERT BUISSON - 95470 VEMARS

Numéro de téléphone 06 44 19 90 01

Adresse e-mail : cabaret.hugo@orange.fr

Le Directeur de la publication est : hugo cabaret
...
L'application Talk&Poke permet à l'Utilisateur un accès gratuit aux services suivants :
...
·         par mail à l'adresse mail cabaret.hugo@orange.fr
...
Les sources des informations diffusées sur l'application Talk&Poke sont réputées fiables mais le site ne garantit pas qu’il soit exempt de défauts, d’erreurs ou d’omissions.
...
Des liens hypertextes peuvent être présents sur le site. L’Utilisateur est informé qu’en cliquant sur ces liens, il sortira de l'application Talk&Poke Ce dernier n’a pas de contrôle sur les pages web sur lesquelles aboutissent ces liens et ne saurait, en aucun cas, être responsable de leur contenu.
...
Les cookies sont de petits fichiers stockés temporairement sur le disque dur de l’ordinateur de l’Utilisateur par votre navigateur et qui sont nécessaires à l’utilisation du site www.imsep.fr. Les cookies ne contiennent pas d’information personnelle et ne peuvent pas être utilisés pour identifier quelqu’un. Un cookie contient un identifiant unique, généré aléatoirement et donc anonyme. Certains cookies expirent à la fin de la visite de l’Utilisateur, d’autres restent.

L’information contenue dans les cookies est utilisée pour améliorer le site www.imsep.fr.
